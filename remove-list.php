...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>List Successfully Deleted</h1>
        <?php
        // Remove the list for the customer and show a success message
        $barcode = 20080104020258;
if (isset($_SESSION['barcode'])) {
  $barcode = $_SESSION['barcode'];
}
        $list_id = $_POST['list_id'];
        $result = PolarisAPI::PatronAccountDeleteTitleList($barcode, $list_id);
        ?>
        <!-- Show a success message. -->
        <p class="bg-success" style="padding: 10px;"><i class="fa fa-thumbs-o-up"></i> The list was successfully removed!</p>
      </div>
    </div>
