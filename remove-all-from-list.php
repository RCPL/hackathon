...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Items Successfully Removed</h1>
        <?php
        ...
        $result = PolarisAPI::PatronTitleListDeleteAllTitles($barcode, $list_id);
        ?>
        <!-- Show a success message. -->
        <p class="bg-success" style="padding: 10px;"><i class="fa fa-thumbs-o-up"></i> The items were successfully removed from your list!</p>
      </div>
    </div>
