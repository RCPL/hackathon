  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        ?>
        <?php if ($success != TRUE) : ?>
          <form action="add-to-list.php?success=true" method="post">
            <input type="hidden" id="item_id" name="item_id" value="<?php print $_GET['ControlNumber']; ?>">
        ...
        <?php else : ?>
          <!-- If they submit the form, add the title to that list. -->
          <?php
          $barcode = 20080104020258;
if (isset($_SESSION['barcode'])) {
  $barcode = $_SESSION['barcode'];
          ...
          // Look up the item based on the id number.
          $bib_record = PolarisAPI::getBib($item_id);
          $title = '';
          ...
          $result = PolarisAPI::PatronTitleListAddTitle($barcode, $list_id, $item_id, $title);
          ?>
          <!-- Show a success message. -->
          <p class="bg-success" style="padding: 10px;"><i class="fa fa-thumbs-o-up"></i> Your item was successfully added to your list!</p>
        <?php endif; ?>
      </div>
    </div>
