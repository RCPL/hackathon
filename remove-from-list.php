  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        $result = PolarisAPI::PatronTitleListDeleteTitle($barcode, $list_id, $postion);
        ?>
        <!-- Show a success message. -->
        <p class="bg-success" style="padding: 10px;"><i class="fa fa-thumbs-o-up"></i> The item was successfully removed!</p>
      </div>
    </div>
